...
my_user_followers1 = my_user.get_followers_list_set(username,my_user_appid,sessionid)
my_user_followers2 = my_user.get_followers_list_set(username,my_user_appid,sessionid)
my_user_followers3 = my_user.get_followers_list_set(username,my_user_appid,sessionid)
my_user_following1 = my_user.get_following_list_set(username,my_user_appid,sessionid)
my_user_following2 = my_user.get_following_list_set(username,my_user_appid,sessionid)
my_user_following3 = my_user.get_following_list_set(username,my_user_appid,sessionid)
